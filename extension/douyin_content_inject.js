// Browser MCP Douyin response observer — runs in MAIN world at document_start.
//
// Douyin remains responsible for request signing, cookies, and transport. This
// observer only clones bounded response text and never changes page requests.

(() => {
  if (window.__browserMcpDouyinObserverInstalled) return;
  window.__browserMcpDouyinObserverInstalled = true;
  ...
  async function observedFetch(input) {
